<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Secretaria.aspx.vb" Inherits="seca.Secretaria"%>
  ...
  return this
	...
	<body bottomMargin="1" bgProperties="fixed" background="fondo menu.jpg">
		<form id="Form1" method="post" runat="server">
			...
			<P>&nbsp;</P>
			<P>
				<asp:Label id="Label3" runat="server" ForeColor="#FFFFC0" Font-Names="Arial" Font-Bold="True" Font-Size="Smaller" Width="51px">Secretaria</asp:Label></P>
			<P>
