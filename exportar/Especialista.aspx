<%@ Page Language="vb" AutoEventWireup="false" Codebehind="Especialista.aspx.vb" Inherits="seca.Especialista"%>
  ...
  return this
	...
	<body bottomMargin="1" bgProperties="fixed" background="fondo menu.jpg">
		<form id="Form1" method="post" runat="server">
			...
			<P>&nbsp;</P>
			<P>
				<asp:Label id="Label3" runat="server" ForeColor="#FFFFC0" Font-Names="Arial" Width="139px" Height="3px" Font-Size="Smaller" Font-Bold="True">Especialista</asp:Label></P>
			<P>
