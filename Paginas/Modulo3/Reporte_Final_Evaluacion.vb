...
Public Class Reporte_Final_Evaluacion
    ...
    Public Overrides Property ResourceName As [String]
        Get
            Return "Reporte_Final_Evaluacion.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReporte_Final_Evaluacion
    Inherits Component
    ...
    Public Overridable Function CreateReport() As ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Reporte_Final_Evaluacion = New Reporte_Final_Evaluacion
        rpt.Site = Me.Site
        Return rpt
    End Function
