...
#Region " Web Form Designer Generated Code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.SqlDataAdapter1.TableMappings.AddRange(New System.Data.Common.DataTableMapping() {New System.Data.Common.DataTableMapping("Table", "SECA_obser_eva_final", New System.Data.Common.DataColumnMapping() {New System.Data.Common.DataColumnMapping("alumno", "alumno"), New System.Data.Common.DataColumnMapping("cod_alumno", "cod_alumno")})})
        '
        'SqlSelectCommand1
        '
        Me.SqlSelectCommand1.CommandText = "SELECT Alumno AS alumno, cod_alumno FROM SECA_obser_eva_final GROUP BY Alumno, co" & _
        "d_alumno ORDER BY Alumno"
        ...
        Me.SqlDataAdapter2.TableMappings.AddRange(New System.Data.Common.DataTableMapping() {New System.Data.Common.DataTableMapping("Table", "SECA_obser_eva_final", New System.Data.Common.DataColumnMapping() {New System.Data.Common.DataColumnMapping("eval", "eval"), New System.Data.Common.DataColumnMapping("cod_eva", "cod_eva")})})
        '
        'SqlSelectCommand2
        '
        Me.SqlSelectCommand2.CommandText = "SELECT Evaluación AS eval, cod_eva FROM SECA_obser_eva_final GROUP BY Evaluación," & _
        " cod_eva ORDER BY Evaluación"
...
#End Region
    ...
    Private Sub L_Evaluacion_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles L_Evaluacion.SelectedIndexChanged
        ...
        CrystalReportViewer1.SelectionFormula = ("{SECA_obser_eva_final.cod_alumno} = " & L_alumnoimagen.SelectedItem.Value) & (" and {SECA_obser_eva_final.cod_eva} = " & L_Evaluacionimagen.SelectedItem.Value)

        'Response.Write(CrystalReportViewer1.SelectionFormula)
    ...
    Private Sub L_Alumno_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles L_Alumno.SelectedIndexChanged
        ...
        L_Evaluacionimagen.DataValueField = "cod_eva"
        L_Evaluacion.DataTextField = "eval"
