<%@ Page Language="vb" AutoEventWireup="false" Codebehind="alumno_desactivar.aspx.vb" Inherits="seca.Mostrar_alumno" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>Desactivar_alumno</title>
	...
	<body MS_POSITIONING="GridLayout" background="../../Imagenes/fondo cuadros1.jpg">
		<form id="Form1" method="post" runat="server">
				...
				<tr>
					<td align="middle" bgColor="#87cefa">
						<p class="MsoNormal" style="FONT-FAMILY: Arial" align="center">
							...
							ser desactivados cuando la Directora lo requiera..</p>
					</td>
				</tr>
			</table>
			<p></p>
			...
			<table align="center" style="WIDTH: 485px; HEIGHT: 33px">
				<tr>
					<td align="middle">
						<p style="FONT-FAMILY: Arial" align="center"><asp:label id="Label3" runat="server" Width="474px" Font-Names="Arial" Font-Bold="True" ForeColor="Black" BackColor="SkyBlue" BorderColor="SlateBlue" BorderStyle="Double"> Selección de Alumnos a Desactivar.</asp:label></p>
					</td>
				</tr>
			</table>
			<TABLE id="Table11" cellSpacing="1" cellPadding="1" width="300" align="center" border="0" bgColor="#ffffff">
				<TR>
					<TD><asp:datagrid id="Grid1" runat="server" AutoGenerateColumns="False" GridLines="Vertical" CellPadding="3" BackColor="White" BorderWidth="1px" BorderStyle="None" BorderColor="#999999" Height="66px" Width="482px" OnItemCommand="Grid_Command" AllowSorting="True" AllowPaging="True" PageSize="15">
							...
							<PagerStyle VerticalAlign="Top" HorizontalAlign="Center" ForeColor="Black" BackColor="#999999" Mode="NumericPages"></PagerStyle>
						</asp:datagrid></TD>
				</TR>
				<TR>
					<TD>
						<P><FONT face="Arial">Seleccione el alumno a desactivar, luego presione el botón de 
								Desactivar.</FONT></P>
					</TD>
				</TR>
				<TR>
					<TD align="middle">
						...
						<P><FONT face="Arial"><STRONG>Usted ha seleccionado desactivar este alumno:</STRONG></FONT></P>
					</TD>
				</TR>
			</TABLE>
			...
			<TABLE cellSpacing="1" cellPadding="1" width="300" align="center" border="0">
				<tr>
					<td align="middle">
						<asp:Button id="Button1" runat="server" BackColor="Red" Height="22px" Width="101px" Text="Desactivar!" ForeColor="White" Font-Bold="True"></asp:Button></td>
				</tr>
			</TABLE>
		</form>
	</body>
